            ...
            <section className="relative w-full max-w-10/12 h-[600px] md:h-[700px]">
                ...
                <div className="absolute inset-0 bg-white/70 md:bg-white/10 rounded-xl">
                    <div className="absolute inset-0 flex items-center justify-center md:justify-end px-6 md:px-20">
                        <div className="max-w-xl text-white text-center md:text-left space-y-5">
                            <div className="flex items-center justify-center md:justify-start space-x-2">
                                ...
                                <span className="text-sm text-black">score from 10,000 rating</span>
                            </div>
                            ...
                            <button className="bg-white text-black font-semibold px-6 py-3 rounded-lg shadow hover:bg-red-500">
                                View Recipes
                            </button>
                        </div>
                    </div>
